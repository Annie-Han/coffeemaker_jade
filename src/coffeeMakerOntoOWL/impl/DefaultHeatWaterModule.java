...
/**
* Protege name: http://www.owl-ontologies.com/CoffeeMaker.owl#HeatWaterModule
* @author OntologyBeanGenerator v4.1
* @version 2014/06/20, 15:47:24
*/
public class DefaultHeatWaterModule implements HeatWaterModule {

  private static final long serialVersionUID = -3583265682521255949L;

  private String _internalInstanceName = null;

  public DefaultHeatWaterModule() {
    this._internalInstanceName = "";
  }

  public DefaultHeatWaterModule(String instance_name) {
